...
describe('Service Tests', () => {
    ...
    describe('AlbanjarProductAlbanjar Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AlbanjarProductAlbanjarService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/albanjar-products/' + 123);
            });
            it('should return AlbanjarProductAlbanjar', () => {

                let entity: AlbanjarProductAlbanjar;
                service.find(123).subscribe((_entity: AlbanjarProductAlbanjar) => {
                    entity = _entity;
                });
