...
describe('Service Tests', () => {
    ...
    describe('AlbanjarDeliveryAlbanjar Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AlbanjarDeliveryAlbanjarService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/albanjar-deliveries/' + 123);
            });
            it('should return AlbanjarDeliveryAlbanjar', () => {

                let entity: AlbanjarDeliveryAlbanjar;
                service.find(123).subscribe((_entity: AlbanjarDeliveryAlbanjar) => {
                    entity = _entity;
                });
