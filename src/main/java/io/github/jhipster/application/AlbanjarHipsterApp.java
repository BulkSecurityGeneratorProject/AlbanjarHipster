...
public class AlbanjarHipsterApp {

    private static final Logger log = LoggerFactory.getLogger(AlbanjarHipsterApp.class);

    private final Environment env;

    public AlbanjarHipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes AlbanjarHipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AlbanjarHipsterApp.class);
